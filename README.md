...
![diagram_003 9-alteration_3_c](https://user-images.githubusercontent.com/50364461/213695161-59310860-0d2f-4c38-94b1-acd1a53029f3.png)
### 3.d. run.do
...
Now you can start exploring the waveform dump generated by the simulation run. While exploring, keep in mind the sections on Interface Signals and Operating State Machine. From there, you can evaluate how your test bench stimuli behave against the APB protocol standard.

That's it for this post. But we'll leave that for part 2. And happy waveform checking!
